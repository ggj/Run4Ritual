...
ENTITY_CREATOR("Mummy", MummyEntity)

MummyEntity::MummyEntity()
	: EnemyEntity("Mummy", "Mummy")
{
	fVelocity = 0.55f;
	sEnemy.displayName = "Mummy";
}

void MummyEntity::Update(f32 dt)
{
	//if (!pBody)
		//return;
