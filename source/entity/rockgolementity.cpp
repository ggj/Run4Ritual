...
ENTITY_CREATOR("RockGolem", RockGolemEntity)

RockGolemEntity::RockGolemEntity()
	: EnemyEntity("RockGolem", "RockGolem")
{
	fVelocity = 0.55f;
	sEnemy.displayName = "RockGolem";
}

void RockGolemEntity::Update(f32 dt)
{
	//if (!pBody)
		//return;
